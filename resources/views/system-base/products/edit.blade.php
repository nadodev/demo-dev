            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group">
                    ...
                    <select id="category" 
                        ...
                        <option value="eletronicos" {{ old('category', $product->category) == 'eletronicos' ? 'selected' : '' }}>Eletrônicos</option>
                        <option value="roupas" {{ old('category', $product->category) == 'roupas' ? 'selected' : '' }}>Roupas</option>
                        <option value="casa" {{ old('category', $product->category) == 'casa' ? 'selected' : '' }}>Casa e Jardim</option>
                        <option value="esportes" {{ old('category', $product->category) == 'esportes' ? 'selected' : '' }}>Esportes</option>
                        <option value="livros" {{ old('category', $product->category) == 'livros' ? 'selected' : '' }}>Livros</option>
